...
<section class="content">
	<h1  style= "margin-bottom:30px" class="ui header">Hasil Perhitungan</h1>
	
	<a href="cetak.php"  class="TOMBOL">CETAK LAPORAN</a>
	
	<table  style= "margin-top:30px" class="ui mt-5 celled table">
		<thead>
		<tr>
