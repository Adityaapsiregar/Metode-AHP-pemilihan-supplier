...
<section class="content" style="padding-top:100px; margin-right:100px; margin-left:100px;">
	...
	<p align="right" style="margin-right:50px;"> D'Besto Chicken & Burger</p>
	<p align="right" style="margin-right:85px;"> Kepala Logistik</p>
	<p align="right" style="margin-right:92px;">
	<?php 
	echo date(' d-m-Y');
	?>
	</p>
			...
			<p align="right" style="margin-right:72px;">(__________________)</p>
