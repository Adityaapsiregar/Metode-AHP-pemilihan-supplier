...
<body>
<header style="background-color:#DC0000 ;">

<img  src="screenshot/logo.png" alt="" align="left" style="width:150px;height:100px;" >
	<h1 style="font-size:38px">SPK PEMILIHAN SUPPLIER DAGING AYAM TERBAIK </h1>
	<h1 style="font-size:38px"></h1>
</header>

<div class="wrapper">
	<nav style="background-color:#850000 ;" id="navigation" role="navigation">
		<ul>
